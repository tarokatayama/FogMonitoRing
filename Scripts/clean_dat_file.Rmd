...
write.csv(spicyraw6_13, row.names = FALSE, file = "./raw_data/SB/spicyraw6_13.csv")
...
write.csv(spicyraw6_10, row.names = FALSE, file = "./raw_data/SB/spicyraw6_10.csv")
...
#combine csv files (still working on this)
SB_files = list.files(path = "./raw_data/SB/", pattern= "*.csv", full.names = TRUE)
SB_files
