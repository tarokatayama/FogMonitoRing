...
compareplot<- ggplot()+
  geom_line(data = NN_6_7, aes(x = RECORD, y = LWmV_50ft_Avg))+
  geom_point(data= NN_6_7, aes(x = RECORD, y = LWmV_66ft_Avg)) +
  geom_line(data= NN_6_7, aes(x = RECORD, y = LWmV_17ft_Avg, color="red"))+
